...
sensors_to_icons = {
    ...
    'sensor.speedometer':       'carla_speedometer', #Debug sensors
    'sensor.spectator':         'carla_camera',
    'sensor.other.gt_gnss':     'carla_gnss',
    'sensor.other.gt_imu':      'carla_imu',
...
class LeaderboardEvaluator(object):
    ...
    def _load_and_wait_for_world(self, args, town, ego_vehicles=None):
        ...
        if int(os.environ['DISABLE_RENDERING']):
...
def main():
    ...
    try:
        ...
        os._exit(222)  # Mark successful completion
    except Exception as e:
        traceback.print_exc()
    finally:
        del leaderboard_evaluator
